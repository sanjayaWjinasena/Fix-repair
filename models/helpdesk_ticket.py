...
class HelpdeskTicket(models.Model):
    ...
    def _get_view(self, view_id=None, view_type='form', **options):
        ...
        if view_type == 'form':
            ...
            # Dispatch sibling: same action 195, shown once a return picking exists —
            # opens wizard pre-loaded with the stored collection picking
            # (x_studio_pick_id) and customer return location so the user just
            # clicks Return to create the dispatch.
